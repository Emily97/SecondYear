...
public class Magazine {
    ...
    public static void main(String[] args){
        ...
        do {
            System.out.println("Press 1 to create a new subscriber");
            System.out.println("Press 2 to delete existing subscriber");
            System.out.println("Press 3 to view all subscribers");
            System.out.println("Press 4 to update a subscriber information");
            System.out.println("Press 5 when you are finished");
            System.out.println();
            ...
            switch (opt) {
                ...
                case 2: {
                    System.out.println("Deleting subscriber");
                    deleteSubscription(input, model);
                    break;
                }
                case 3: {
                    System.out.println("View all subscribers");
                    viewSubscription(model);
                    break;
                }
                case 4: {
                    System.out.println("Update a subscriber");
    ...
    private static void viewSubscription(Model model) {
        ...
        for (Subscription sr : subscription) {
            ...
            System.out.println("Name: " + sr.getCustomerName());
            System.out.println("Address: " + sr.getAddress());
            System.out.println("Price plan: " + sr.getPrice());
            System.out.println("Age: " + sr.getAge());
            System.out.println("Deals info: " + sr.getDeals());
        }
    }
    ...
    private static void updateSubscription(Scanner input, Model model) {
        System.out.print("Enter the customer number of the subscriber to update:");
        ...
        do {
            ...
            switch (opt2) {
                ...
                case 4: {
                    System.out.println("Update customer subscription price:");
                    updateSubscription(input,model);
                    break;
                }
                case 5: {
                ...
                case 6: {
                    System.out.println("Update customer subscription plan:");
                    updateSubscription(input,model);
                    break;
                }
            }
